...
function addServiceRemark() {
    var remarkText = "PO Remark:\n" +
        ...
        "- สำหรับงานไฟฟ้า คู่ค้าจะต้องจัดเตรียมและส่งรายการอุปกรณ์ให้หน่วยงานตรวจสอบและอนุมัติก่อนเริ่มงาน\n" +
        "- ผู้รับเหมาทุกคนที่เข้าปฏิบัติงานต้องผ่านการอบรมความปลอดภัยก่อนเริ่มปฏิบัติงาน\n";
