...
<div class="print-tag-selection">
    ...
    <table class="table table-bordered">
        ...
        <?php foreach ($selectedProducts as $index => $product): ?>
            <tr>
                <td><?= Html::encode($product['ref_po']) ?></td>
                <td><?= Html::encode($product['description']) ?></td>
                <td><?= Html::encode($product['model']) ?></td>
                <td><?= Html::encode($product['brand']) ?></td>
                <td><?= Html::encode($product['quantity']) ?></td>
                <td>
                    <?= Html::hiddenInput("products[$index][product]", json_encode($product)) ?>
