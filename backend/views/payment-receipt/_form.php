            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-group mb-4">
                        <?= $form->field($model, 'billing_invoice_id')->widget(Select2::class, [
                            'data' => ArrayHelper::map(
                                ...
                                'id',
                                function($model) {
                                    return $model->billing_number . ' - ' . ($model->customer->name ?? 'N/A') . ' (' . number_format($model->total_amount, 2) . ' บาท)';
                                }
                            ),
                            'options' => [
                                'placeholder' => 'เลือกใบแจ้งหนี้...',
                                'id' => 'paymentreceipt-billing_invoice_id'
                            ],
                            'pluginOptions' => [
                                'allowClear' => true,
                                'width' => '100%'
                        ...
                        <div id="invoice-info" class="mt-3"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?= $form->field($model, 'received_by')->widget(Select2::class, [
                                ...
                                'options' => ['placeholder' => 'เลือกผู้รับเงิน...'],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                    'width' => '100%'
                                ],
                    ...
                    <?= $form->field($model, 'payment_method')->dropDownList(
                        PaymentReceipt::getPaymentMethods(),
                        [
                            'prompt' => 'เลือกวิธีการชำระ...',
                            'id' => 'paymentreceipt-payment_method',
                            'class' => 'form-select'
                        ]
                    ) ?>
