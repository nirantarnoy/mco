...
<div class="invoice-create-bill-placement">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-file-invoice"></i> สร้างใบวางบิล</h5>
            </div>
            
            <?php $form = ActiveForm::begin(['id' => 'bill-placement-form']); ?>
