...
<div class="dashboard-index">
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title">เลือกช่วงเวลา</h5>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title">เปรียบเทียบราคาขายกับต้นทุน</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title">สินค้าขายดี 10 อันดับ</h5>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title">รายงานยอดขายแยกตามสินค้า</h5>
                </div>
                <div class="card-body">
