...
<body>
    ...
    <div class="wht-form">
        ...
        <div style="margin-top: 20px; text-align: center; position: relative;">
            ...
            <div style="position: absolute; right: 80px; top: 10px; width: 100px; height: 100px; border: 1px dashed #ccc; border-radius: 50%; display: flex; align-items: center; justify-content: center; opacity: 0.3;">
                <span style="font-size: 10px; transform: rotate(-15deg);">ประทับตรา<br>นิติบุคคล</span>
            </div>
        </div>
