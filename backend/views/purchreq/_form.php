    ...
    <div class="purch-req-form">
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($model->purchReqLines as $index => $purchReqLine): ?>
                            <tr class="item">
                                ...
                                <td>
                                    <?=$form->field($purchReqLine,"[{$index}]product_description")->textarea(['class'=>'form-control line-product-description'])->label(false);?>
                                </td>
                                <td>
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-4 text-end">
                                        <span id="summary-vat" class="fw-bold"><?= $model->vat_amount ?></span> บาท
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
        ...
        <div class="form-group mt-3">
            <div class="d-flex justify-content-between">
                <?php if (($model->approve_status !=1 && $model->status != 3) || $model->isNewRecord || \Yii::$app->user->can('purchreq/approve')): ?>
