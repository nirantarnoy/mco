        ...
        <div class="card-body">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-md-6 mb-2 mb-md-0">
                    ...
                    <?= Html::a('<i class="fas fa-file-excel"></i> Export to Express', array_merge(['export-express'], Yii::$app->request->queryParams), [
                        'class' => 'btn btn-info',
                        'data-pjax' => '0',
                        'target' => '_blank'
                    ]) ?>
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'before' => Html::a('<i class="fas fa-plus"></i> สร้างใหม่', ['create'], ['class' => 'btn btn-success']) . ' ' .
                Html::a('<i class="fas fa-file-excel"></i> Export to Express', array_merge(['export-express'], Yii::$app->request->queryParams), ['class' => 'btn btn-info', 'data-pjax' => '0']),
            'after' => false,
        ],
        'toolbar' => [
            '{export}',
            ...
            [
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model, $key) {
                        return $model->approve_status == Quotation::APPROVE_STATUS_PENDING ? Html::a('<i class="fas fa-trash"></i>', $url, [
                            'title' => 'ลบ',
