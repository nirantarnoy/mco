        ...
        <div class="col-lg-10">
            <div class="btn-group">
                <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างใหม่'), ['create'], ['class' => 'btn btn-success']) ?>
                 <form action="<?= Url::to(['customer/export-customers'], true) ?>" method="post" data-pjax="0"
                       style="margin-left: 10px">
                     <button class="btn btn-info"><i class="fa fa-download"></i> Export vendors</button>
                 </form>
                 <form action="<?= Url::to(['customer/export-express'], true) ?>" method="post" data-pjax="0"
...
<div class="row" style="display: nonex;">
    <form action="<?= \yii\helpers\Url::to(['customer/importcustomer'], true) ?>" method="post"
