...
/**
 * WorkerSearch represents the model behind the search form of `backend\models\Worker`.
 */
class WorkerSearch extends Worker
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'fnam', 'lname', 'description', 'phone', 'idcard_no', 'doc'], 'safe'],
            [['globalSearch'], 'string'],
        ];
    }
    ...
    public function search($params, $formName = null)
    {
        ...
        if ($this->globalSearch != '') {
            $query->orFilterWhere(['like', 'name', $this->globalSearch])
                ->orFilterWhere(['like', 'fnam', $this->globalSearch])
