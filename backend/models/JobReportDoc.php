...
/**
 * This is the model class for table "job_report_doc".
 *
 * @property int $id
 * @property int $job_id รหัสใบงาน
 * @property string|null $folder_name ชื่อโฟลเดอร์
 ...
 * @property Job $job
 */
class JobReportDoc extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['file_name', 'file_path', 'folder_name'], 'string', 'max' => 255],
