 ...
 * @property DebitNoteItem[] $debitNoteItems
 */
class DebitNote extends \yii\db\ActiveRecord
{
    ...
    /**
     * Gets query for [[DebitNoteItems]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getDebitNoteItems()
    {
        return $this->hasMany(DebitNoteItem::class, ['debit_note_id' => 'id'])->orderBy(['item_no' => SORT_ASC]);
    }
