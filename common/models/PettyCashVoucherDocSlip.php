...
/**
 * This is the model class for table "petty_cash_voucher_doc_slip".
 *
 * @property int $id
 ...
 */
class PettyCashVoucherDocSlip extends \yii\db\ActiveRecord
{
    ...
    {
        return 'petty_cash_voucher_doc_slip';
    }
