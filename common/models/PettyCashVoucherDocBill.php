...
/**
 * This is the model class for table "petty_cash_voucher_doc_bill".
 *
 * @property int $id
 ...
 */
class PettyCashVoucherDocBill extends \yii\db\ActiveRecord
{
    ...
    {
        return 'petty_cash_voucher_doc_bill';
    }
